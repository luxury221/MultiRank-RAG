...
- **MultiRank 重排序**：提供 G0-G4 / V0-V5 消融框架，逐步加入语义相似、图传播、bridge evidence、reference matching、视觉 grounding、证据链约束和 ABECD + Evidence Guard 增强主线。
...
- [docs/PUBLIC_BENCHMARK_RESULTS.md](docs/PUBLIC_BENCHMARK_RESULTS.md)：公开数据集 V0-V5 消融结果
